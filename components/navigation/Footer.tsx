        ...
        <footer
            ...
            <div
                ...
                <div className="me-12 hidden lg:block">
                    <span>Resta in contatto con noi nei social:</span>
                </div>
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="">
                        ...
                        <p>
                        Inks è il tuo angolo di magia letteraria: condividi le emozioni dei tuoi libri preferiti, scopri nuove letture e unisciti a una comunità che vive la passione per la lettura.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mb-4 flex items-center justify-center md:justify-start">
                            ...
                            Via dei velini, Macerata (Mc), Italia
                        </p>
                        <p className="mb-4 flex items-center justify-center md:justify-start">
                            <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
                                <svg
